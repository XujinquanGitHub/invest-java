...
public class YunFeiLoginUtil {
    ...
    public String login(String username, String password) {
        ...
        formMap.put("__EVENTVALIDATION", "/wEdAASHu/AagveqK95rnmcNoyh1zCVMJGnCxB7ZG7bkLlekEsa8wzphH9jstV6K9RvF+kh0OWarNtHZvueomBCnXS0aJnehRfEWK+fFgD1yJv1o0Z7UrAidTWQaJDTtweYIOKc=");
        ...
        // 保存Cookie到文件
        if (cookies != null) {
            cookieManager.saveCookies(BASE_URL, cookies);
        }
    ...
    public String getCookies() {
        return cookieManager.loadCookies(BASE_URL);
    }
} 